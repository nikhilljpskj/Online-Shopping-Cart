                    ...
                    <tbody>
                        <?php foreach ($data as $row) { ?>
                            <tr>
                                ...
                                <td><?php echo $row->manaer_name ?></td>
                                <td><?php echo (isset($row->production_qty) ? $row->production_qty : 0) ?></td>
                                <td><?php echo (isset($row->extra_qty) ? $row->extra_qty : 0) ?></td>
                                <td><?php echo (isset($row->total_qty) ? $row->total_qty : 0) ?></td>   
                                <td><?php if ($row->work_status == 'Pending') { ?><a href="<?php echo base_url("workorder/work_order_material_issue?wo_no=".$row->id); ?>" class="btn btn-primary">Inventory issue</a> |  <a href="<?php echo base_url("workorder/work_order_material_issue_completed?wo_no=".$row->id) ?>" class="btn btn-primary">Completed</a><?php } ?></td>    
                            </tr>
                        <?php } ?>
